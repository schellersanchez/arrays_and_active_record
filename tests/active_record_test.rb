...
class ActiveRecordTest < Test::Unit::TestCase
  ...
  def test_limit
    ...
    cars = 5.times.map { Car.create }
    # put your code here
    offset_number = Car.count - cars.count

    limited_cars = Car.limit(4).offset(offset_number)
  ...
  def test_offset
    ...
    cars = 5.times.map {Car.create}
    # put your code here
    offset_number = Car.count - cars.count + 1

    offset_cars = Car.offset(offset_number).limit(2)
